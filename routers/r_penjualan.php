...
// mengalihkan halaman kembali ke data_barang.php
    header("location:../views/detail_pembelian.php?id=$PelangganID");
...
// menginput data ke database
    $sql = "INSERT INTO `detailpenjualan` (`DetailID`, `PenjualanID`, `ProdukID`, `JumlahProduk`, `Subtotal`) VALUES (NULL, '$PenjualanID', NULL, '', '');";
